...
public class student_box5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.student_box5);
        ...
        wordList = dbDatabase.getRecord5(student_name);
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (choice1.isChecked() || choice2.isChecked()) {
                        ...
                        Toast.makeText(student_box5.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    String word= wordQuestion.getText().toString();
                    if (choice1.isChecked()){
                        Integer isDeleted = dbDatabase.deleteFromBox5(student_name,word);
                        if (isDeleted > 0) {
                            Toast.makeText(student_box5.this, "word has been deleted from box5", Toast.LENGTH_SHORT).show();
                        }
                        else{ Toast.makeText(student_box5.this, "There is a problem\n try again", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void finishQuiz() {
        if (questionCountTotal==0){
            Toast.makeText(student_box5.this, "There are no Questions in this box", Toast.LENGTH_SHORT).show();
            finish();
        }
        else {
            Intent i = new Intent(student_box5.this, showFinalScore.class);
