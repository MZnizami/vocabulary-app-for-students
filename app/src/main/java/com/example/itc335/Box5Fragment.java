...
public class Box5Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.fragment_box5,container,false);
    ...
    public void  displayWord1() {
        Cursor cursor=mydb.showBoxesScoreToInstructor5();
