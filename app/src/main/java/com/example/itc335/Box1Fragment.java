...
public class Box1Fragment extends Fragment {
...
getRecordBox1ScoreAdapter adapter;
 ...
 vocabDatabase mydb;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.fragment_box1,container,false);
    ...
    public void  displayWord1() {
        Cursor cursor=mydb.showBoxesScoreToInstructor();
