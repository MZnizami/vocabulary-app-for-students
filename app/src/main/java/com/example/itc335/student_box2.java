...
public class student_box2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.student_box2);
        ...
        wordList = dbDatabase.getRecord2(student_name);
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (choice1.isChecked() || choice2.isChecked()) {
                        ...
                        Toast.makeText(student_box2.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    ...
                    if (choice1.isChecked()){
                        int point1=3;
                        boolean isInserted2 = dbDatabase.insertDataIntoBox3(student_name,word,rightMeaning,wrongMeaning,point1);
                        if (isInserted2) {
                            Toast.makeText(student_box2.this, "Data added to box3", Toast.LENGTH_SHORT).show();
                        }
                        else{ Toast.makeText(student_box2.this, "There is a problem\n try again", Toast.LENGTH_SHORT).show();
                        }
                        ////////////////////////////////////////////////////////////deletion ////////////////////////////////////
                        Integer isDeleted = dbDatabase.deleteFromBox2(student_name,word);
                        if (isDeleted > 0) {
                            Toast.makeText(student_box2.this, "word has been deleted from box5", Toast.LENGTH_SHORT).show();
                        }
                        else{ Toast.makeText(student_box2.this, "There is a problem\n try again", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void finishQuiz() {
        if (questionCountTotal==0){
            Toast.makeText(student_box2.this, "There are no Questions in this box", Toast.LENGTH_SHORT).show();
            finish();
        }
        else{
        Intent i = new Intent(student_box2.this, showFinalScore.class);
